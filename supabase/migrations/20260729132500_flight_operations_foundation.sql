...
-- Scheduled flights already exist in public.routes.
-- Operated flights already exist in public.flights.
...
create index if not exists idx_flight_bookings_route_id
on public.flight_bookings(route_id);
