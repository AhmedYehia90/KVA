-- KVA OS Pillar 09 — Museum / History RC1 Hotfix 1
-- Fixes the Pilot Museum projection after RC1 referenced pilot_passports.id,
-- while the existing Universal Pilot Passport model is keyed by pilot_id.
--
-- This is an additive migration because 20260812220000 has already been applied.
-- It only replaces the read-only RPC definition. No data/table/economy/fleet/
-- route/PIREP mutation is performed.
...
-- Ask PostgREST to refresh function metadata after replacement.
